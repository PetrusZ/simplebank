...
import (
	...
	"github.com/PetrusZ/simplebank/api"
	db "github.com/PetrusZ/simplebank/db/sqlc"
	_ "github.com/PetrusZ/simplebank/doc/statik"
	"github.com/PetrusZ/simplebank/gapi"
	"github.com/PetrusZ/simplebank/mail"
...
func runGatewayServer(config util.Config, store db.Store, taskDistributor worker.TaskDistributor) {
	...
	log.Info().Msgf("starting HTTP gateway server at %s", config.HTTPServerAddress)
